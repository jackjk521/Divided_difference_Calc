					...
					<h4>Specification</h4>
						<div class="row">
							<div class="col-md-6">
								<div class="card mb-3">
									<div class="card-header">
										<h5 class="mb-0">User Manual <BiBook/> </h5> 
									</div>
								<div class="card-body">
									<ol>
										<li>You must input the number of rows</li>
										<li>A table will be generated where you will be able to input the (x,y) points</li>
										<li>Input the value to interpolate
											<ul>
											<li>You may also generate randomized values for the (x,y) points</li>
											</ul>
										</li>
										<li>Click on the Show Output button to generate the output</li>
										<li>The output will display the polynomial function and the final answer</li>
										<li>Click on the Reset button to clear the table and fields</li>
										<li>The graph will be generated from the list of (x,y) points inputted</li>
									</ol>
								</div>
								</div>
							</div>
							<div class="col-md-6">
								<div class="card mb-3">
									<div class="card-header">
										<h5 class="mb-0">Limitations <BsExclamationCircleFill  /> </h5>  
									</div>
										<div class="card-body">
											<ul>
												<li>User must input points x along with the corresponding coefficients y</li>
												<li>User must input point to interpolate</li>
												<li>The program will accept integer and decimal inputs</li>
												<li>The program will show a graph</li>
												<li>The program will output the interpolating polynomial</li>
												<li>The program does not accept any function as an input</li>
												<li>The program does not show the method and steps</li>
												<li>Randomized values only fall under the range of -10 to 10</li>
											</ul>
										</div>
								</div>
							</div>
