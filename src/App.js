    ...
    <div class="row flex-nowrap">
        ...
        <div class="col py-3">
            ...
            <div id="Introduction">
              <h4>Introduction</h4>
              <p class="lead"> 
              The divided differences method is a numerical procedure for interpolating a polynomial given a set of points. Divided differences is a recursive division process. 
            ...
            <div id="specification">
              <h4>Specification</h4>
              I put the new Forgi's on the Jeep I trap until the bloody bottoms is underneath 'Cause all my niggas got it out the streets I keep a hunnid racks inside my jeans I remember hittin' the mall with the whole team
